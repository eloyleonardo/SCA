...
public class FrmAtivarUsuario extends FrmAlterarStatus implements ActionListener {
    ...
    public FrmAtivarUsuario(Vector linha, Vector responsavel, ControladoraUsuario controladora,String servidor) {
        super();
        this.linha = linha;
    ...
    private void ativarUsuario() {
        ...
        if (this.taMotivo.getText().equals("")) {
            ...
            if (controladora.alterarStatus(taMotivo.getText(), responsavel, linha, "Ativar") == true) {
