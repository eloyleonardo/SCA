...
public class FrmSelecionarClasseLog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione o cadastro do Relatório:");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cargo", "Cidade", "Fornecedor", "Material", "Setor", "Uf", "Unidade", "Usuario" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.setor = jComboBox1.getSelectedItem().toString();
    ...
    public void fireDadosObtidos() {
        ObterDadosEvent evt = new ObterDadosEvent(this, this.setor);
